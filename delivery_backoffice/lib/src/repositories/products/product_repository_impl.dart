...
import 'package:delivery_backoffice/src/repositories/products/product_repository.dart';
...
class ProductRepositoryImpl implements ProductRepository {
  ...
  Future<void> deleteProduct(int id) async {
    try {
      ...
      throw RepositoryExceptions(message: 'Erro ao deletar produto');
    }
  }
  ...
  Future<ProductModel> getProduct(int id) async {
    try {
      ...
      throw RepositoryExceptions(message: 'Erro ao buscar produto $id');
    }
  }
  ...
  Future<void> save(ProductModel productModel) async {
    try {
      ...
      throw RepositoryExceptions(message: 'Erro ao salvar produto');
    }
  }
  ...
  Future<String> uploadImageProduct(Uint8List file, String filename) async {
    try {
      ...
      log('Erro ao fazer upload da imagem do produto', error: e, stackTrace: s);
